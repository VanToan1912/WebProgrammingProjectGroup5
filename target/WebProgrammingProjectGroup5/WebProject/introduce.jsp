...
<header id="header">
    ...
    <ul id="nav" class="back-dark-green">
        ...
        <li class="nav-text-product  nav-togethger"><a href="${pageContext.request.contextPath}/WebProject/introduce.jsp" class="nav-togethger">GIỚI THIỆU</a></li>
...
<div id="content" class="content-area page-wrapper" role="main">
    ...
    <img src="asset/img/anh-gioi-thieu/img-giới-thiệu.jpg" alt="" width="30%" class="img-introduce">
