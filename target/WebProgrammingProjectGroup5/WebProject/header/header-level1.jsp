...
<%--              <a href="${pageContext.request.contextPath}/AdminSite/index-admin.jsp">Admin</a>--%>
  ...
  <div class="nav-bar middle-bar row-head ">
    ...
    <a href="${pageContext.request.contextPath}/WebProject/View/purchase.jsp">
      <div class="col-head">
  ...
  <ul id="nav" class="back-dark-green">
    <li>
      ...
      <ul class="sub-nav">
        <li><a href="${pageContext.request.contextPath}/WebProject/View/product.jsp">
    ...
    <li class=" nav-togethger"><a href="${pageContext.request.contextPath}/WebProject/View/Product.jsp">SẢN PHẨM</a></li>
