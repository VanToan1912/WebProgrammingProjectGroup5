  ...
  <div class="container" id="container">
    <div class="password-reset-form">
      <form action="#" method="POST">
        ...
        <div class="input-box">
          <label for="email"><span class="icon"><i class="far fa-envelope"></i></span><strong>Email</strong></label>
          <input type="email" placeholder="Nhập email..." id="email" required>
        </div>
        <div class="h">
          <p>Gửi email khôi phục mật khẩu hoặc quay lại đăng nhập</p>
        </div>
        <div class="button-container">
          <button type="submit" class="btn" name="send">Gửi đến Email</button>
